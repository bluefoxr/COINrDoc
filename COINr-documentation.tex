...
Then you may wish to see chapters on \protect\hyperlink{foundations}{Foundations}, \protect\hyperlink{initial-visualisation-and-analysis}{Initial visualisation and analysis}, \protect\hyperlink{denomination}{Denomination}, \protect\hyperlink{missing-data-and-imputation}{Missing data and Imputation}, \protect\hyperlink{data-treatment}{Data Treatment} and \protect\hyperlink{weighting-2}{Weighting} depending on what you want to do.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(reactable)}
\KeywordTok{library}\NormalTok{(magrittr)}
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{getStats}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{)}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{StatTable }\OperatorTok{%>%}
\StringTok{  }\NormalTok{reactable}\OperatorTok{::}\KeywordTok{reactable}\NormalTok{(}\DataTypeTok{defaultPageSize =} \DecValTok{5}\NormalTok{, }\DataTypeTok{highlight =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{wrap =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{iplotIndDist}\NormalTok{(ASEM, }\StringTok{"Raw"}\NormalTok{, }\StringTok{"Flights"}\NormalTok{, }\DataTypeTok{ptype =} \StringTok{"Histogram"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{plotly}\OperatorTok{::}\KeywordTok{layout}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Customised plot"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{getStats}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{out2 =} \StringTok{"COIN"}\NormalTok{)}
\CommentTok{## Number of collinear indicators =  3}
\CommentTok{## Number of signficant negative indicator correlations =  322}
\CommentTok{## Number of indicators with high denominator correlations =  7}
...
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{StatTable }\OperatorTok{%>%}\StringTok{ }\KeywordTok{roundDF}\NormalTok{() }\OperatorTok{%>%}
\NormalTok{reactable}\OperatorTok{::}\KeywordTok{reactable}\NormalTok{(}\DataTypeTok{resizable =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{bordered =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{highlight =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{defaultPageSize =} \DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(COINr)}
\NormalTok{Ind1 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Country =}\NormalTok{ ASEMIndData}\OperatorTok{$}\NormalTok{UnitName, }\DataTypeTok{ConSpeed =}\NormalTok{ ASEMIndData}\OperatorTok{$}\NormalTok{ConSpeed)}
\NormalTok{Ind1[}\DecValTok{40}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(Ind1),]}
\CommentTok{##               Country ConSpeed}
\CommentTok{## 40              Korea     28.6}
\CommentTok{## 41            Lao PDR       NA}
\CommentTok{## 42           Malaysia      8.9}
\CommentTok{## 43           Mongolia       NA}
\CommentTok{## 44            Myanmar       NA}
\CommentTok{## 45        New Zealand     14.7}
\CommentTok{## 46           Pakistan       NA}
\CommentTok{## 47        Philippines      5.5}
\CommentTok{## 48 Russian Federation     11.8}
\CommentTok{## 49          Singapore     20.3}
\CommentTok{## 50           Thailand     16.0}
\CommentTok{## 51            Vietnam      9.5}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Ind1}\OperatorTok{$}\NormalTok{ConSpeed <-}\StringTok{ }\KeywordTok{replace}\NormalTok{(Ind1}\OperatorTok{$}\NormalTok{ConSpeed, }\KeywordTok{is.na}\NormalTok{(Ind1}\OperatorTok{$}\NormalTok{ConSpeed), }\KeywordTok{mean}\NormalTok{(Ind1}\OperatorTok{$}\NormalTok{ConSpeed, }\DataTypeTok{na.rm =}\NormalTok{ T))}
\NormalTok{Ind1[}\DecValTok{40}\OperatorTok{:}\KeywordTok{nrow}\NormalTok{(Ind1),]}
\CommentTok{##               Country ConSpeed}
\CommentTok{## 40              Korea 28.60000}
\CommentTok{## 41            Lao PDR 14.28605}
\CommentTok{## 42           Malaysia  8.90000}
\CommentTok{## 43           Mongolia 14.28605}
\CommentTok{## 44            Myanmar 14.28605}
\CommentTok{## 45        New Zealand 14.70000}
\CommentTok{## 46           Pakistan 14.28605}
\CommentTok{## 47        Philippines  5.50000}
\CommentTok{## 48 Russian Federation 11.80000}
\CommentTok{## 49          Singapore 20.30000}
\CommentTok{## 50           Thailand 16.00000}
\CommentTok{## 51            Vietnam  9.50000}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{assemble}\NormalTok{(}\DataTypeTok{IndData =}\NormalTok{ COINr}\OperatorTok{::}\NormalTok{ASEMIndData, }\DataTypeTok{IndMeta =}\NormalTok{ COINr}\OperatorTok{::}\NormalTok{ASEMIndMeta,}
                 \DataTypeTok{AggMeta =}\NormalTok{ COINr}\OperatorTok{::}\NormalTok{ASEMAggMeta)}
\CommentTok{## -----------------}
\CommentTok{## Denominators detected - stored in .$Input$Denominators}
\CommentTok{## -----------------}
\CommentTok{## -----------------}
...
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{checkData}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{)}
\KeywordTok{head}\NormalTok{(ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{MissDatSummary)}
\CommentTok{##   UnitCode N_missing N_zero N_miss_or_zero PrcDataAll PrcNonZero LowDataAll}
\CommentTok{## 1      AUT         0      2              2        100   95.91837      FALSE}
\CommentTok{## 2      BEL         0      2              2        100   95.91837      FALSE}
\CommentTok{## 3      BGR         0      0              0        100  100.00000      FALSE}
\CommentTok{## 4      HRV         0      1              1        100   97.95918      FALSE}
\CommentTok{## 5      CYP         0      3              3        100   93.87755      FALSE}
\CommentTok{## 6      CZE         0      3              3        100   93.87755      FALSE}
\CommentTok{##   ZeroFlag LowDatOrZeroFlag Included}
\CommentTok{## 1    FALSE            FALSE     TRUE}
\CommentTok{## 2    FALSE            FALSE     TRUE}
\CommentTok{## 3    FALSE            FALSE     TRUE}
\CommentTok{## 4    FALSE            FALSE     TRUE}
\CommentTok{## 5    FALSE            FALSE     TRUE}
\CommentTok{## 6    FALSE            FALSE     TRUE}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Missing data check on the raw data set}
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{checkData}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{ind_thresh =} \FloatTok{0.85}\NormalTok{, }\DataTypeTok{unit_screen =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{RemovedUnits}
...
\NormalTok{df <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{UnitCode =} \KeywordTok{c}\NormalTok{(}\StringTok{"AUT"}\NormalTok{,}\StringTok{"BRN"}\NormalTok{), }\DataTypeTok{Status =} \KeywordTok{c}\NormalTok{(}\StringTok{"Exclude"}\NormalTok{, }\StringTok{"Include"}\NormalTok{))}

\CommentTok{# Missing data check on the raw data set}
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{checkData}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{ind_thresh =} \FloatTok{0.85}\NormalTok{, }\DataTypeTok{unit_screen =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{Force =}\NormalTok{ df)}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{RemovedUnits}
\CommentTok{## [1] "AUT"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{MissDatByGroup[}\DecValTok{30}\OperatorTok{:}\DecValTok{40}\NormalTok{,])}
\CommentTok{##    UnitCode ConEcFin    Instit P2P Physical Political Environ    Social}
\CommentTok{## 30      GBR      100 100.00000 100    100.0       100     100 100.00000}
\CommentTok{## 31      AUS      100 100.00000 100    100.0       100     100 100.00000}
\CommentTok{## 32      BGD      100  83.33333  75     87.5       100     100  88.88889}
\CommentTok{## 33      BRN       80 100.00000  75     87.5       100     100  55.55556}
\CommentTok{## 34      KHM       80 100.00000  75     87.5       100     100  77.77778}
\CommentTok{## 35      CHN      100 100.00000 100    100.0       100     100 100.00000}
\CommentTok{##    SusEcFin      Conn      Sust     Index}
\CommentTok{## 30      100 100.00000 100.00000 100.00000}
\CommentTok{## 31      100 100.00000 100.00000 100.00000}
\CommentTok{## 32       80  86.66667  89.47368  87.75510}
\CommentTok{## 33       60  86.66667  68.42105  79.59184}
\CommentTok{## 34      100  86.66667  89.47368  87.75510}
\CommentTok{## 35       80 100.00000  94.73684  97.95918}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# ASEM <- assemble(IndData = COINr::ASEMIndData, IndMeta = COINr::ASEMIndMeta,}
\CommentTok{#                 AggMeta = COINr::ASEMAggMeta)}

\CommentTok{# check how many NAs we have}
\KeywordTok{sum}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Raw))}
\CommentTok{## [1] 63}

\CommentTok{# impute using indicator mean}
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{impute}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{imtype =} \StringTok{"ind_mean"}\NormalTok{)}
\CommentTok{## Missing data points detected = 63}
\CommentTok{## Missing data points imputed = 63, using method = ind_mean}

\CommentTok{# check how many NAs after imputation}
\KeywordTok{sum}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Imputed))}
\CommentTok{## [1] 0}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{tradeperGDP <-}\StringTok{ }\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{Goods}\OperatorTok{/}\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Input}\OperatorTok{$}\NormalTok{Denominators}\OperatorTok{$}\NormalTok{Den_GDP}
\CommentTok{# bar chart: add unit names first}
\KeywordTok{iplotBar}\NormalTok{(}\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{UnitCode =}\NormalTok{ ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{UnitCode, }\DataTypeTok{TradePerGDP =}\NormalTok{ tradeperGDP))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Raw}
\CommentTok{## # A tibble: 51 x 56}
\CommentTok{##    UnitCode UnitName  Year Group_GDP Group_GDPpc Group_Pop Group_EurAsia  Goods}
\CommentTok{##    <chr>    <chr>    <dbl> <chr>     <chr>       <chr>     <chr>          <dbl>}
\CommentTok{##  1 AUT      Austria   2018 L         XL          M         Europe        278.  }
\CommentTok{##  2 BEL      Belgium   2018 L         L           L         Europe        598.  }
\CommentTok{##  3 BGR      Bulgaria  2018 S         S           M         Europe         42.8 }
\CommentTok{##  4 HRV      Croatia   2018 S         M           S         Europe         28.4 }
\CommentTok{##  5 CYP      Cyprus    2018 S         L           S         Europe          8.77}
\CommentTok{##  6 CZE      Czech R~  2018 M         L           M         Europe        274.  }
\CommentTok{##  7 DNK      Denmark   2018 L         XL          M         Europe        147.  }
\CommentTok{##  8 EST      Estonia   2018 S         M           S         Europe         28.2 }
\CommentTok{##  9 FIN      Finland   2018 M         XL          M         Europe        102.  }
\CommentTok{## 10 FRA      France    2018 XL        L           L         Europe        849.  }
\CommentTok{## # ... with 41 more rows, and 48 more variables: Services <dbl>, FDI <dbl>,}
\CommentTok{## #   PRemit <dbl>, ForPort <dbl>, CostImpEx <dbl>, Tariff <dbl>, TBTs <dbl>,}
\CommentTok{## #   TIRcon <dbl>, RTAs <dbl>, Visa <dbl>, StMob <dbl>, Research <dbl>,}
\CommentTok{## #   Pat <dbl>, CultServ <dbl>, CultGood <dbl>, Tourist <dbl>, MigStock <dbl>,}
\CommentTok{## #   Lang <dbl>, LPI <dbl>, Flights <dbl>, Ship <dbl>, Bord <dbl>, Elec <dbl>,}
\CommentTok{## #   Gas <dbl>, ConSpeed <dbl>, Cov4G <dbl>, Embs <dbl>, IGOs <dbl>,}
\CommentTok{## #   UNVote <dbl>, Renew <dbl>, PrimEner <dbl>, CO2 <dbl>, MatCon <dbl>,}
\CommentTok{## #   Forest <dbl>, Poverty <dbl>, Palma <dbl>, TertGrad <dbl>, FreePress <dbl>,}
\CommentTok{## #   TolMin <dbl>, NGOs <dbl>, CPI <dbl>, FemLab <dbl>, WomParl <dbl>,}
\CommentTok{## #   PubDebt <dbl>, PrivDebt <dbl>, GDPGrow <dbl>, RDExp <dbl>, NEET <dbl>}
\CommentTok{# The denominators}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Input}\OperatorTok{$}\NormalTok{Denominators}
\CommentTok{## # A tibble: 51 x 11}
\CommentTok{##    UnitCode UnitName  Year Group_GDP Group_GDPpc Group_Pop Group_EurAsia}
\CommentTok{##    <chr>    <chr>    <dbl> <chr>     <chr>       <chr>     <chr>        }
\CommentTok{##  1 AUT      Austria   2018 L         XL          M         Europe       }
\CommentTok{##  2 BEL      Belgium   2018 L         L           L         Europe       }
\CommentTok{##  3 BGR      Bulgaria  2018 S         S           M         Europe       }
\CommentTok{##  4 HRV      Croatia   2018 S         M           S         Europe       }
\CommentTok{##  5 CYP      Cyprus    2018 S         L           S         Europe       }
\CommentTok{##  6 CZE      Czech R~  2018 M         L           M         Europe       }
\CommentTok{##  7 DNK      Denmark   2018 L         XL          M         Europe       }
\CommentTok{##  8 EST      Estonia   2018 S         M           S         Europe       }
\CommentTok{##  9 FIN      Finland   2018 M         XL          M         Europe       }
\CommentTok{## 10 FRA      France    2018 XL        L           L         Europe       }
\CommentTok{## # ... with 41 more rows, and 4 more variables: Den_Area <dbl>,}
\CommentTok{## #   Den_Energy <dbl>, Den_GDP <dbl>, Den_Pop <dbl>}
\CommentTok{# The mapping of denominators to indicators (see Denominator column)}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Input}\OperatorTok{$}\NormalTok{IndMeta}
\CommentTok{## # A tibble: 49 x 10}
\CommentTok{##    IndName IndCode Direction IndWeight Denominator IndUnit  Target Agg1  Agg2 }
\CommentTok{##    <chr>   <chr>       <dbl>     <dbl> <chr>       <chr>     <dbl> <chr> <chr>}
\CommentTok{##  1 Trade ~ Goods           1         1 Den_GDP     Trilli~ 1.82e+3 ConE~ Conn }
\CommentTok{##  2 Trade ~ Servic~         1         1 Den_GDP     Millio~ 6.24e+2 ConE~ Conn }
\CommentTok{##  3 Foreig~ FDI             1         1 Den_GDP     Billio~ 7.18e+1 ConE~ Conn }
\CommentTok{##  4 Person~ PRemit          1         1 Den_GDP     Millio~ 2.87e+1 ConE~ Conn }
\CommentTok{##  5 Foreig~ ForPort         1         1 Den_GDP     Millio~ 1.01e+4 ConE~ Conn }
...
\NormalTok{denomby_meta <-}\StringTok{ }\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Input}\OperatorTok{$}\NormalTok{IndMeta}\OperatorTok{$}\NormalTok{Denominator}
\CommentTok{# Example: we want to change the denominator of flights from population to GDP}
\NormalTok{denomby_meta[ASEM}\OperatorTok{$}\NormalTok{Input}\OperatorTok{$}\NormalTok{IndMeta}\OperatorTok{$}\NormalTok{IndCode }\OperatorTok{==}\StringTok{ "Flights"}\NormalTok{] <-}\StringTok{ "Den_GDP"}
\CommentTok{# Now re-denominate. Return data frame for inspection}
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{denominate}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{specby =} \StringTok{"user"}\NormalTok{, }\DataTypeTok{denomby =}\NormalTok{ denomby_meta)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{getStats}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{out2 =} \StringTok{"COIN"}\NormalTok{, }\DataTypeTok{t_denom =} \FloatTok{0.8}\NormalTok{)}
\CommentTok{## Number of collinear indicators =  3}
\CommentTok{## Number of signficant negative indicator correlations =  322}
\CommentTok{## Number of indicators with high denominator correlations =  4}
\CommentTok{# get the result}
\NormalTok{ctable <-}\StringTok{ }\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Raw}\OperatorTok{$}\NormalTok{DenomCorrelations}
\CommentTok{# remove first column}
\NormalTok{ctable <-}\StringTok{ }\NormalTok{ctable[}\OperatorTok{-}\DecValTok{1}\NormalTok{]}
\CommentTok{# return only columns that have entries with correlation above 0.8}
\NormalTok{ctable[,}\KeywordTok{colSums}\NormalTok{((}\KeywordTok{abs}\NormalTok{(ctable) }\OperatorTok{>}\StringTok{ }\FloatTok{0.8}\NormalTok{))}\OperatorTok{>}\DecValTok{0}\NormalTok{]}
\CommentTok{##       Goods       FDI     StMob  CultGood}
\CommentTok{## 1 0.2473558 0.3668625 0.5228032 0.2696675}
\CommentTok{## 2 0.6276219 0.7405170 0.7345030 0.7120445}
\CommentTok{## 3 0.8026770 0.8482453 0.8379575 0.8510374}
\CommentTok{## 4 0.4158811 0.6529376 0.5523545 0.5028121}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{GDP =}\NormalTok{ WorldDenoms}\OperatorTok{$}\NormalTok{Den_GDP,}
                 \DataTypeTok{LogGDP =} \KeywordTok{log}\NormalTok{(WorldDenoms}\OperatorTok{$}\NormalTok{Den_GDP))}
\KeywordTok{plotIndDist}\NormalTok{(df, }\DataTypeTok{type =} \StringTok{"Histogram"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{treat}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Denominated"}\NormalTok{, }\DataTypeTok{winmax =} \DecValTok{5}\NormalTok{)}

\CommentTok{# Check which indicators were treated, and how}
\KeywordTok{library}\NormalTok{(dplyr, }\DataTypeTok{quietly =}\NormalTok{ T, }\DataTypeTok{verbose =}\NormalTok{ F)}
\KeywordTok{library}\NormalTok{(magrittr)}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Treated}\OperatorTok{$}\NormalTok{TreatSummary }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Treatment }\OperatorTok{!=}\StringTok{ "None"}\NormalTok{)}
\CommentTok{##       IndCode Low High           TreatSpec           Treatment}
\CommentTok{## V2   Services   0    4 Default, winmax = 5 Winsorised 4 points}
\CommentTok{## V3        FDI   0    2 Default, winmax = 5 Winsorised 2 points}
\CommentTok{## V5    ForPort   0    3 Default, winmax = 5 Winsorised 3 points}
\CommentTok{## V6  CostImpEx   0    1 Default, winmax = 5 Winsorised 1 points}
\CommentTok{## V7     Tariff   0    3 Default, winmax = 5 Winsorised 3 points}
\CommentTok{## V12     StMob   0    2 Default, winmax = 5 Winsorised 2 points}
\CommentTok{## V15  CultServ   0    2 Default, winmax = 5 Winsorised 2 points}
\CommentTok{## V21   Flights   0    1 Default, winmax = 5 Winsorised 1 points}
\CommentTok{## V23      Bord   0    3 Default, winmax = 5 Winsorised 3 points}
\CommentTok{## V25       Gas   0    3 Default, winmax = 5 Winsorised 3 points}
\CommentTok{## V35    Forest   0    2 Default, winmax = 5 Winsorised 2 points}
\CommentTok{## V36   Poverty   0    3 Default, winmax = 5 Winsorised 3 points}
\CommentTok{## V41      NGOs   0    3 Default, winmax = 5 Winsorised 3 points}
\CommentTok{## V43    FemLab   1    0 Default, winmax = 5 Winsorised 1 points}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# treat at defaults}
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{treat}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Denominated"}\NormalTok{, }\DataTypeTok{winmax =} \DecValTok{3}\NormalTok{, }\DataTypeTok{deflog =} \StringTok{"CTlog"}\NormalTok{)}

\CommentTok{# Check which indicators were treated, and how}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Treated}\OperatorTok{$}\NormalTok{TreatSummary }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Treatment }\OperatorTok{!=}\StringTok{ "None"}\NormalTok{)}
\CommentTok{##       IndCode Low High           TreatSpec               Treatment}
\CommentTok{## V2   Services   0    0 Default, winmax = 3 CTLog (exceeded winmax)}
\CommentTok{## V3        FDI   0    2 Default, winmax = 3     Winsorised 2 points}
\CommentTok{## V5    ForPort   0    3 Default, winmax = 3     Winsorised 3 points}
\CommentTok{## V6  CostImpEx   0    1 Default, winmax = 3     Winsorised 1 points}
\CommentTok{## V7     Tariff   0    3 Default, winmax = 3     Winsorised 3 points}
\CommentTok{## V12     StMob   0    2 Default, winmax = 3     Winsorised 2 points}
\CommentTok{## V15  CultServ   0    2 Default, winmax = 3     Winsorised 2 points}
\CommentTok{## V21   Flights   0    1 Default, winmax = 3     Winsorised 1 points}
\CommentTok{## V23      Bord   0    3 Default, winmax = 3     Winsorised 3 points}
\CommentTok{## V25       Gas   0    3 Default, winmax = 3     Winsorised 3 points}
\CommentTok{## V35    Forest   0    2 Default, winmax = 3     Winsorised 2 points}
\CommentTok{## V36   Poverty   0    3 Default, winmax = 3     Winsorised 3 points}
\CommentTok{## V41      NGOs   0    3 Default, winmax = 3     Winsorised 3 points}
\CommentTok{## V43    FemLab   1    0 Default, winmax = 3     Winsorised 1 points}

\CommentTok{# Compare before and after treatment}
\KeywordTok{iplotIndDist2}\NormalTok{(ASEM, }\DataTypeTok{dsets =} \KeywordTok{c}\NormalTok{(}\StringTok{"Denominated"}\NormalTok{, }\StringTok{"Treated"}\NormalTok{), }\DataTypeTok{icodes =} \StringTok{"Services"}\NormalTok{,}
              \DataTypeTok{ptype =} \StringTok{"Histogram"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{treat}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Denominated"}\NormalTok{, }\DataTypeTok{individual =}\NormalTok{ individual,}
              \DataTypeTok{indiv_only =} \OtherTok{FALSE}\NormalTok{)}
\CommentTok{# Check which indicators were treated, and how}
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Treated}\OperatorTok{$}\NormalTok{TreatSummary }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(Treatment }\OperatorTok{!=}\StringTok{ "None"}\NormalTok{)}
\CommentTok{##       IndCode Low High               TreatSpec               Treatment}
\CommentTok{## V2   Services   0    0              Forced log                     Log}
\CommentTok{## V3        FDI   0    2     Default, winmax = 6     Winsorised 2 points}
\CommentTok{## V5    ForPort   0    3     Default, winmax = 6     Winsorised 3 points}
\CommentTok{## V6  CostImpEx   0    1     Default, winmax = 6     Winsorised 1 points}
\CommentTok{## V7     Tariff   0    0          Forced Box-Cox Box Cox with lambda = 2}
\CommentTok{## V12     StMob   0    2     Default, winmax = 6     Winsorised 2 points}
\CommentTok{## V15  CultServ   0    2     Default, winmax = 6     Winsorised 2 points}
\CommentTok{## V23      Bord   0    3 Forced Win, winmax = 10     Winsorised 3 points}
\CommentTok{## V25       Gas   0    3     Default, winmax = 6     Winsorised 3 points}
\CommentTok{## V35    Forest   0    2     Default, winmax = 6     Winsorised 2 points}
\CommentTok{## V36   Poverty   0    3     Default, winmax = 6     Winsorised 3 points}
\CommentTok{## V41      NGOs   0    3     Default, winmax = 6     Winsorised 3 points}
\CommentTok{## V43    FemLab   1    0     Default, winmax = 6     Winsorised 1 points}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Aggregated[(}\KeywordTok{ncol}\NormalTok{(ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Aggregated)}\OperatorTok{-}\DecValTok{5}\NormalTok{)}\OperatorTok{:}\StringTok{ }\KeywordTok{ncol}\NormalTok{(ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Aggregated)]}
\CommentTok{## # A tibble: 51 x 6}
\CommentTok{##    Environ Social SusEcFin  Conn  Sust Index}
\CommentTok{##      <dbl>  <dbl>    <dbl> <dbl> <dbl> <dbl>}
\CommentTok{##  1    71.0   67.0     65.7  50.4  67.9  59.1}
\CommentTok{##  2    55.9   86.3     53.5  54.8  65.3  60.0}
\CommentTok{##  3    56.4   54.0     62.5  42.4  57.6  50.0}
\CommentTok{##  4    76.0   54.8     55.5  45.9  62.1  54.0}
\CommentTok{##  5    61.9   59.5     31.1  45.5  50.8  48.2}
\CommentTok{##  6    53.7   61.1     72.0  48.9  62.3  55.6}
\CommentTok{##  7    72.5   79.8     62.7  51.0  71.7  61.4}
\CommentTok{##  8    35.7   68.3     70.1  49.5  58.0  53.8}
\CommentTok{##  9    52.9   82.1     63.8  48.2  66.3  57.2}
\CommentTok{## 10    66.5   60.8     54.2  47.0  60.5  53.7}
\CommentTok{## # ... with 41 more rows}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{NewWeights <-}\StringTok{ }\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Parameters}\OperatorTok{$}\NormalTok{Weights}\OperatorTok{$}\NormalTok{Original}

\KeywordTok{head}\NormalTok{(NewWeights)}
\CommentTok{##   AgLevel      Code Weight}
\CommentTok{## 1       1     Goods      1}
\CommentTok{## 2       1  Services      1}
\CommentTok{## 3       1       FDI      1}
\CommentTok{## 4       1    PRemit      1}
\CommentTok{## 5       1   ForPort      1}
\CommentTok{## 6       1 CostImpEx      1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NewWeights}\OperatorTok{$}\NormalTok{Weight[NewWeights}\OperatorTok{$}\NormalTok{Code }\OperatorTok{==}\StringTok{ "Conn"}\NormalTok{] <-}\StringTok{ }\FloatTok{0.5}

\KeywordTok{tail}\NormalTok{(NewWeights)}
\CommentTok{##    AgLevel     Code Weight}
\CommentTok{## 55       2  Environ    1.0}
\CommentTok{## 56       2   Social    1.0}
\CommentTok{## 57       2 SusEcFin    1.0}
\CommentTok{## 58       3     Conn    0.5}
\CommentTok{## 59       3     Sust    1.0}
\CommentTok{## 60       4    Index    1.0}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Parameters}\OperatorTok{$}\NormalTok{Weights}\OperatorTok{$}\NormalTok{NewWeights <-}\StringTok{ }\NormalTok{NewWeights}

\CommentTok{# Aggregate again to get new results}
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{aggregate}\NormalTok{(ASEM, }\DataTypeTok{agweights =} \StringTok{"NewWeights"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ASEM}\OperatorTok{$}\NormalTok{Analysis}\OperatorTok{$}\NormalTok{Weights}\OperatorTok{$}\NormalTok{OptimsedLev3}\OperatorTok{$}\NormalTok{CorrResults}
\CommentTok{##   Desired  Obtained OptWeight}
\CommentTok{## 1     0.5 0.8971336     0.400}
\CommentTok{## 2     0.5 0.8925119     0.625}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{EffWeights <-}\StringTok{ }\KeywordTok{effectiveWeight}\NormalTok{(ASEM)}

\NormalTok{EffWeights}\OperatorTok{$}\NormalTok{EffectiveWeightsList}
\CommentTok{##    AgLevel      Code EffectiveWeight}
\CommentTok{## 1        1     Goods      0.02000000}
\CommentTok{## 2        1  Services      0.02000000}
\CommentTok{## 3        1       FDI      0.02000000}
\CommentTok{## 4        1    PRemit      0.02000000}
\CommentTok{## 5        1   ForPort      0.02000000}
\CommentTok{## 6        1 CostImpEx      0.01666667}
\CommentTok{## 7        1    Tariff      0.01666667}
\CommentTok{## 8        1      TBTs      0.01666667}
\CommentTok{## 9        1    TIRcon      0.01666667}
\CommentTok{## 10       1      RTAs      0.01666667}
\CommentTok{## 11       1      Visa      0.01666667}
\CommentTok{## 12       1     StMob      0.01250000}
\CommentTok{## 13       1  Research      0.01250000}
\CommentTok{## 14       1       Pat      0.01250000}
\CommentTok{## 15       1  CultServ      0.01250000}
\CommentTok{## 16       1  CultGood      0.01250000}
\CommentTok{## 17       1   Tourist      0.01250000}
\CommentTok{## 18       1  MigStock      0.01250000}
\CommentTok{## 19       1      Lang      0.01250000}
\CommentTok{## 20       1       LPI      0.01250000}
\CommentTok{## 21       1   Flights      0.01250000}
\CommentTok{## 22       1      Ship      0.01250000}
\CommentTok{## 23       1      Bord      0.01250000}
\CommentTok{## 24       1      Elec      0.01250000}
\CommentTok{## 25       1       Gas      0.01250000}
\CommentTok{## 26       1  ConSpeed      0.01250000}
\CommentTok{## 27       1     Cov4G      0.01250000}
\CommentTok{## 28       1      Embs      0.03333333}
\CommentTok{## 29       1      IGOs      0.03333333}
\CommentTok{## 30       1    UNVote      0.03333333}
\CommentTok{## 31       1     Renew      0.03333333}
\CommentTok{## 32       1  PrimEner      0.03333333}
\CommentTok{## 33       1       CO2      0.03333333}
\CommentTok{## 34       1    MatCon      0.03333333}
\CommentTok{## 35       1    Forest      0.03333333}
\CommentTok{## 36       1   Poverty      0.01851852}
\CommentTok{## 37       1     Palma      0.01851852}
\CommentTok{## 38       1  TertGrad      0.01851852}
\CommentTok{## 39       1 FreePress      0.01851852}
\CommentTok{## 40       1    TolMin      0.01851852}
\CommentTok{## 41       1      NGOs      0.01851852}
\CommentTok{## 42       1       CPI      0.01851852}
...
\NormalTok{ASEM <-}\StringTok{ }\KeywordTok{build_ASEM}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{suppressMessages}\NormalTok{()}

\CommentTok{# get results table, top 10}
\KeywordTok{getResults}\NormalTok{(ASEM) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{(}\DecValTok{10}\NormalTok{)}
\CommentTok{##    UnitCode    UnitName Index Rank}
\CommentTok{## 1       CHE Switzerland 68.38    1}
\CommentTok{## 2       NLD Netherlands 64.82    2}
\CommentTok{## 3       DNK     Denmark 64.80    3}
\CommentTok{## 4       NOR      Norway 64.47    4}
\CommentTok{## 5       BEL     Belgium 63.54    5}
\CommentTok{## 6       SWE      Sweden 63.00    6}
\CommentTok{## 7       AUT     Austria 61.90    7}
\CommentTok{## 8       LUX  Luxembourg 61.58    8}
\CommentTok{## 9       DEU     Germany 60.75    9}
\CommentTok{## 10      MLT       Malta 60.36   10}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{getResults}\NormalTok{(ASEM, }\DataTypeTok{tab_type =} \StringTok{"Aggregates"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{reactable}\OperatorTok{::}\KeywordTok{reactable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{getResults}\NormalTok{(ASEM, }\DataTypeTok{tab_type =} \StringTok{"Aggregates"}\NormalTok{, }\DataTypeTok{use =} \StringTok{"ranks"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{reactable}\OperatorTok{::}\KeywordTok{reactable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{getUnitSummary}\NormalTok{(ASEM, }\DataTypeTok{usel =} \StringTok{"GBR"}\NormalTok{, }\DataTypeTok{aglevs =} \KeywordTok{c}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SAW <-}\StringTok{ }\KeywordTok{getStrengthNWeak}\NormalTok{(ASEM, }\DataTypeTok{usel =} \StringTok{"GBR"}\NormalTok{)}
\NormalTok{SAW}\OperatorTok{$}\NormalTok{Strengths  }\OperatorTok{%>%}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SAW}\OperatorTok{$}\NormalTok{Weaknesses  }\OperatorTok{%>%}\StringTok{ }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{custlist =}\StringTok{ }\KeywordTok{list}\NormalTok{(}\DataTypeTok{after_treat =} \KeywordTok{quote}\NormalTok{(ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Treated}\OperatorTok{$}\NormalTok{Bord[ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Treated}\OperatorTok{$}\NormalTok{UnitCode}\OperatorTok{==}\StringTok{"BEL"}\NormalTok{] <-}\StringTok{ }\NormalTok{ASEM2}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Imputed}\OperatorTok{$}\NormalTok{Bord[ASEM}\OperatorTok{$}\NormalTok{Data}\OperatorTok{$}\NormalTok{Imputed}\OperatorTok{$}\NormalTok{UnitCode}\OperatorTok{==}\StringTok{"BEL"}\NormalTok{]))}

\CommentTok{# Add the list to the $Method$Custom folder}
\NormalTok{ASEM2}\OperatorTok{$}\NormalTok{Method}\OperatorTok{$}\NormalTok{Custom <-}\StringTok{ }\NormalTok{custlist}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ASEM_NoLPIShip <-}\StringTok{ }\NormalTok{ASEM}

\CommentTok{# Edit method: exclude two indicators}
\NormalTok{ASEM_NoLPIShip}\OperatorTok{$}\NormalTok{Method}\OperatorTok{$}\NormalTok{assemble}\OperatorTok{$}\NormalTok{exclude <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"LPI"}\NormalTok{, }\StringTok{"Ship"}\NormalTok{)}

\CommentTok{# Regenerate results (suppress any messages)}
\NormalTok{ASEM_NoLPIShip <-}\StringTok{ }\KeywordTok{regen}\NormalTok{(ASEM_NoLPIShip, }\DataTypeTok{quietly =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Make a copy}
\NormalTok{ASEM_NoBord <-}\StringTok{ }\NormalTok{ASEM_NoLPIShip}

\CommentTok{# Edit method: exclude two indicators}
\NormalTok{ASEM_NoBord}\OperatorTok{$}\NormalTok{Method}\OperatorTok{$}\NormalTok{assemble}\OperatorTok{$}\NormalTok{exclude <-}\StringTok{ "Bord"}

\CommentTok{# Regenerate results}
\NormalTok{ASEM_NoBord <-}\StringTok{ }\KeywordTok{regen}\NormalTok{(ASEM_NoBord, }\DataTypeTok{quietly =} \OtherTok{TRUE}\NormalTok{)}

\NormalTok{ASEM_NoBord}\OperatorTok{$}\NormalTok{Parameters}\OperatorTok{$}\NormalTok{IndCodes}
\CommentTok{##  [1] "Goods"     "Services"  "FDI"       "PRemit"    "ForPort"   "CostImpEx"}
\CommentTok{##  [7] "Tariff"    "TBTs"      "TIRcon"    "RTAs"      "Visa"      "StMob"    }
\CommentTok{## [13] "Research"  "Pat"       "CultServ"  "CultGood"  "Tourist"   "MigStock" }
\CommentTok{## [19] "Lang"      "LPI"       "Flights"   "Ship"      "Elec"      "Gas"      }
\CommentTok{## [25] "ConSpeed"  "Cov4G"     "Embs"      "IGOs"      "UNVote"    "Renew"    }
\CommentTok{## [31] "PrimEner"  "CO2"       "MatCon"    "Forest"    "Poverty"   "Palma"    }
\CommentTok{## [37] "TertGrad"  "FreePress" "TolMin"    "NGOs"      "CPI"       "FemLab"   }
\CommentTok{## [43] "WomParl"   "PubDebt"   "PrivDebt"  "GDPGrow"   "RDExp"     "NEET"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Make a copy}
\NormalTok{ASEM_NoBord2 <-}\StringTok{ }\KeywordTok{indChange}\NormalTok{(ASEM_NoLPIShip, }\DataTypeTok{drop =} \StringTok{"Bord"}\NormalTok{, }\DataTypeTok{regen =} \OtherTok{TRUE}\NormalTok{)}
\CommentTok{## COIN has been regenerated using new specs.}

\NormalTok{ASEM_NoBord2}\OperatorTok{$}\NormalTok{Parameters}\OperatorTok{$}\NormalTok{IndCodes}
\CommentTok{##  [1] "Goods"     "Services"  "FDI"       "PRemit"    "ForPort"   "CostImpEx"}
\CommentTok{##  [7] "Tariff"    "TBTs"      "TIRcon"    "RTAs"      "Visa"      "StMob"    }
\CommentTok{## [13] "Research"  "Pat"       "CultServ"  "CultGood"  "Tourist"   "MigStock" }
\CommentTok{## [19] "Lang"      "Flights"   "Elec"      "Gas"       "ConSpeed"  "Cov4G"    }
\CommentTok{## [25] "Embs"      "IGOs"      "UNVote"    "Renew"     "PrimEner"  "CO2"      }
\CommentTok{## [31] "MatCon"    "Forest"    "Poverty"   "Palma"     "TertGrad"  "FreePress"}
\CommentTok{## [37] "TolMin"    "NGOs"      "CPI"       "FemLab"    "WomParl"   "PubDebt"  }
\CommentTok{## [43] "PrivDebt"  "GDPGrow"   "RDExp"     "NEET"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Make a copy}
\NormalTok{ASEMAltImpute <-}\StringTok{ }\NormalTok{ASEM}

\CommentTok{# Edit .$Method}
\NormalTok{ASEMAltImpute}\OperatorTok{$}\NormalTok{Method}\OperatorTok{$}\NormalTok{impute}\OperatorTok{$}\NormalTok{imtype <-}\StringTok{ "indgroup_median"}

\CommentTok{# Regenerate}
\NormalTok{ASEMAltImpute <-}\StringTok{ }\KeywordTok{regen}\NormalTok{(ASEMAltImpute, }\DataTypeTok{quietly =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Make a copy}
\NormalTok{ASEMAltNorm <-}\StringTok{ }\NormalTok{ASEM}

\CommentTok{# Edit .$Method}
\NormalTok{ASEMAltNorm}\OperatorTok{$}\NormalTok{Method}\OperatorTok{$}\NormalTok{normalise}\OperatorTok{$}\NormalTok{ntype <-}\StringTok{ "borda"}

\CommentTok{# Regenerate}
\NormalTok{ASEMAltNorm <-}\StringTok{ }\KeywordTok{regen}\NormalTok{(ASEMAltNorm, }\DataTypeTok{quietly =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{compTable}\NormalTok{(ASEM, ASEMAltNorm, }\DataTypeTok{dset =} \StringTok{"Aggregated"}\NormalTok{, }\DataTypeTok{isel =} \StringTok{"Index"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{compTable}\NormalTok{(ASEM, ASEMAltNorm, }\DataTypeTok{dset =} \StringTok{"Aggregated"}\NormalTok{, }\DataTypeTok{isel =} \StringTok{"Index"}\NormalTok{, }\DataTypeTok{sort_by =} \StringTok{"RankCOIN1"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{head}\NormalTok{(}\DecValTok{10}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{## Iteration 1 of 100 ... 1% complete}
\CommentTok{## Iteration 2 of 100 ... 2% complete}
\CommentTok{## Iteration 3 of 100 ... 3% complete}
\CommentTok{## Iteration 4 of 100 ... 4% complete}
\CommentTok{## Iteration 5 of 100 ... 5% complete}
\CommentTok{## Iteration 6 of 100 ... 6% complete}
\CommentTok{## Iteration 7 of 100 ... 7% complete}
\CommentTok{## Iteration 8 of 100 ... 8% complete}
\CommentTok{## Iteration 9 of 100 ... 9% complete}
\CommentTok{## Iteration 10 of 100 ... 10% complete}
\CommentTok{## Iteration 11 of 100 ... 11% complete}
\CommentTok{## Iteration 12 of 100 ... 12% complete}
\CommentTok{## Iteration 13 of 100 ... 13% complete}
\CommentTok{## Iteration 14 of 100 ... 14% complete}
\CommentTok{## Iteration 15 of 100 ... 15% complete}
\CommentTok{## Iteration 16 of 100 ... 16% complete}
\CommentTok{## Iteration 17 of 100 ... 17% complete}
\CommentTok{## Iteration 18 of 100 ... 18% complete}
\CommentTok{## Iteration 19 of 100 ... 19% complete}
\CommentTok{## Iteration 20 of 100 ... 20% complete}
\CommentTok{## Iteration 21 of 100 ... 21% complete}
\CommentTok{## Iteration 22 of 100 ... 22% complete}
\CommentTok{## Iteration 23 of 100 ... 23% complete}
\CommentTok{## Iteration 24 of 100 ... 24% complete}
\CommentTok{## Iteration 25 of 100 ... 25% complete}
\CommentTok{## Iteration 26 of 100 ... 26% complete}
\CommentTok{## Iteration 27 of 100 ... 27% complete}
\CommentTok{## Iteration 28 of 100 ... 28% complete}
\CommentTok{## Iteration 29 of 100 ... 29% complete}
\CommentTok{## Iteration 30 of 100 ... 30% complete}
\CommentTok{## Iteration 31 of 100 ... 31% complete}
\CommentTok{## Iteration 32 of 100 ... 32% complete}
\CommentTok{## Iteration 33 of 100 ... 33% complete}
\CommentTok{## Iteration 34 of 100 ... 34% complete}
\CommentTok{## Iteration 35 of 100 ... 35% complete}
\CommentTok{## Iteration 36 of 100 ... 36% complete}
\CommentTok{## Iteration 37 of 100 ... 37% complete}
\CommentTok{## Iteration 38 of 100 ... 38% complete}
\CommentTok{## Iteration 39 of 100 ... 39% complete}
\CommentTok{## Iteration 40 of 100 ... 40% complete}
\CommentTok{## Iteration 41 of 100 ... 41% complete}
\CommentTok{## Iteration 42 of 100 ... 42% complete}
\CommentTok{## Iteration 43 of 100 ... 43% complete}
\CommentTok{## Iteration 44 of 100 ... 44% complete}
\CommentTok{## Iteration 45 of 100 ... 45% complete}
\CommentTok{## Iteration 46 of 100 ... 46% complete}
\CommentTok{## Iteration 47 of 100 ... 47% complete}
\CommentTok{## Iteration 48 of 100 ... 48% complete}
\CommentTok{## Iteration 49 of 100 ... 49% complete}
\CommentTok{## Iteration 50 of 100 ... 50% complete}
\CommentTok{## Iteration 51 of 100 ... 51% complete}
\CommentTok{## Iteration 52 of 100 ... 52% complete}
\CommentTok{## Iteration 53 of 100 ... 53% complete}
\CommentTok{## Iteration 54 of 100 ... 54% complete}
\CommentTok{## Iteration 55 of 100 ... 55% complete}
\CommentTok{## Iteration 56 of 100 ... 56% complete}
\CommentTok{## Iteration 57 of 100 ... 57% complete}
\CommentTok{## Iteration 58 of 100 ... 58% complete}
\CommentTok{## Iteration 59 of 100 ... 59% complete}
\CommentTok{## Iteration 60 of 100 ... 60% complete}
\CommentTok{## Iteration 61 of 100 ... 61% complete}
\CommentTok{## Iteration 62 of 100 ... 62% complete}
\CommentTok{## Iteration 63 of 100 ... 63% complete}
\CommentTok{## Iteration 64 of 100 ... 64% complete}
\CommentTok{## Iteration 65 of 100 ... 65% complete}
\CommentTok{## Iteration 66 of 100 ... 66% complete}
\CommentTok{## Iteration 67 of 100 ... 67% complete}
\CommentTok{## Iteration 68 of 100 ... 68% complete}
\CommentTok{## Iteration 69 of 100 ... 69% complete}
\CommentTok{## Iteration 70 of 100 ... 70% complete}
\CommentTok{## Iteration 71 of 100 ... 71% complete}
\CommentTok{## Iteration 72 of 100 ... 72% complete}
\CommentTok{## Iteration 73 of 100 ... 73% complete}
\CommentTok{## Iteration 74 of 100 ... 74% complete}
\CommentTok{## Iteration 75 of 100 ... 75% complete}
\CommentTok{## Iteration 76 of 100 ... 76% complete}
\CommentTok{## Iteration 77 of 100 ... 77% complete}
\CommentTok{## Iteration 78 of 100 ... 78% complete}
\CommentTok{## Iteration 79 of 100 ... 79% complete}
\CommentTok{## Iteration 80 of 100 ... 80% complete}
\CommentTok{## Iteration 81 of 100 ... 81% complete}
\CommentTok{## Iteration 82 of 100 ... 82% complete}
\CommentTok{## Iteration 83 of 100 ... 83% complete}
\CommentTok{## Iteration 84 of 100 ... 84% complete}
\CommentTok{## Iteration 85 of 100 ... 85% complete}
\CommentTok{## Iteration 86 of 100 ... 86% complete}
\CommentTok{## Iteration 87 of 100 ... 87% complete}
\CommentTok{## Iteration 88 of 100 ... 88% complete}
\CommentTok{## Iteration 89 of 100 ... 89% complete}
\CommentTok{## Iteration 90 of 100 ... 90% complete}
\CommentTok{## Iteration 91 of 100 ... 91% complete}
\CommentTok{## Iteration 92 of 100 ... 92% complete}
\CommentTok{## Iteration 93 of 100 ... 93% complete}
\CommentTok{## Iteration 94 of 100 ... 94% complete}
\CommentTok{## Iteration 95 of 100 ... 95% complete}
\CommentTok{## Iteration 96 of 100 ... 96% complete}
\CommentTok{## Iteration 97 of 100 ... 97% complete}
\CommentTok{## Iteration 98 of 100 ... 98% complete}
\CommentTok{## Iteration 99 of 100 ... 99% complete}
\CommentTok{## Iteration 100 of 100 ... 100% complete}
\CommentTok{## Time elapsed = 19.93s, average 0.2s/rep.}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{summary}\NormalTok{(SAresults)}
\CommentTok{##            Length Class      Mode     }
\CommentTok{## Scores     101    data.frame list     }
\CommentTok{## Parameters   2    data.frame list     }
\CommentTok{## Ranks      101    data.frame list     }
\CommentTok{## RankStats    6    data.frame list     }
\CommentTok{## Nominal      3    data.frame list     }
\CommentTok{## t_elapse     1    -none-     numeric  }
\CommentTok{## t_average    1    -none-     numeric  }
\CommentTok{## ParaNames    3    -none-     character}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(SAresults}\OperatorTok{$}\NormalTok{Parameters)}
\CommentTok{##          imtype    ntype}
\CommentTok{## 1      ind_mean   minmax}
\CommentTok{## 2 indgroup_mean   minmax}
\CommentTok{## 3 indgroup_mean dist2max}
\CommentTok{## 4 indgroup_mean     rank}
\CommentTok{## 5          none   minmax}
\CommentTok{## 6 indgroup_mean dist2max}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SAresults}\OperatorTok{$}\NormalTok{RankStats}
\CommentTok{##    UnitCode Nominal  Mean Median    Q5   Q95}
\CommentTok{## 1       AUT       7  7.13    7.0  6.00  9.00}
\CommentTok{## 2       BEL       5  5.69    5.0  3.95  9.00}
\CommentTok{## 3       BGR      30 29.69   30.0 28.00 31.00}
\CommentTok{## 4       HRV      18 20.34   20.0 17.00 25.00}
\CommentTok{## 5       CYP      29 29.97   30.0 28.00 33.05}
\CommentTok{## 6       CZE      17 17.01   17.0 15.00 19.00}
\CommentTok{## 7       DNK       3  2.54    2.0  2.00  4.00}
\CommentTok{## 8       EST      22 19.79   18.5 13.00 26.00}
\CommentTok{## 9       FIN      13 13.20   13.0 11.00 15.00}
\CommentTok{## 10      FRA      21 20.68   20.0 18.00 24.00}
\CommentTok{## 11      DEU       9  9.01    9.0  7.00 13.00}
\CommentTok{## 12      GRC      32 32.22   32.0 30.00 34.00}
\CommentTok{## 13      HUN      20 21.37   21.0 19.00 24.00}
\CommentTok{## 14      IRL      12 11.97   11.0 10.00 15.00}
\CommentTok{## 15      ITA      28 28.04   28.0 26.95 29.00}
\CommentTok{## 16      LVA      23 21.94   22.0 19.00 24.05}
\CommentTok{## 17      LTU      16 14.76   16.0 10.00 17.05}
\CommentTok{## 18      LUX       8  8.87    9.0  6.00 12.00}
\CommentTok{## 19      MLT      10 13.29   12.0  9.00 20.05}
\CommentTok{## 20      NLD       2  3.12    3.0  2.00  4.00}
\CommentTok{## 21      NOR       4  3.60    4.0  2.00  5.00}
\CommentTok{## 22      POL      26 26.09   26.0 24.00 28.00}
\CommentTok{## 23      PRT      27 23.64   26.0 15.00 27.00}
\CommentTok{## 24      ROU      25 23.66   24.5 19.00 27.00}
\CommentTok{## 25      SVK      24 23.67   24.0 22.00 26.00}
\CommentTok{## 26      SVN      11  9.72    9.0  7.00 12.00}
\CommentTok{## 27      ESP      19 22.09   22.0 18.00 27.00}
\CommentTok{## 28      SWE       6  5.88    6.0  5.00  7.00}
\CommentTok{## 29      CHE       1  1.00    1.0  1.00  1.00}
\CommentTok{## 30      GBR      15 14.20   15.0 11.00 16.00}
\CommentTok{## 31      AUS      35 35.73   35.0 34.00 39.05}
\CommentTok{## 32      BGD      46 44.85   45.5 39.95 49.00}
\CommentTok{## 33      BRN      40 39.37   39.0 35.00 45.00}
\CommentTok{## 34      KHM      37 36.37   37.0 33.00 39.00}
\CommentTok{## 35      CHN      49 49.57   50.0 47.95 51.00}
\CommentTok{## 36      IND      45 45.54   46.0 41.95 48.00}
\CommentTok{## 37      IDN      43 45.24   45.0 41.00 49.00}
\CommentTok{## 38      JPN      34 33.29   34.0 30.00 35.00}
\CommentTok{## 39      KAZ      47 45.72   46.0 42.00 50.00}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{roundDF}\NormalTok{(SAresults}\OperatorTok{$}\NormalTok{Sensitivity)}
\CommentTok{##   Variable   Si  STi Si_q5 Si_q95 STi_q5 STi_q95}
\CommentTok{## 1   imtype 0.00 0.04 -0.04   0.05   0.03    0.04}
\CommentTok{## 2    ntype 0.54 0.80  0.30   0.77   0.72    0.88}
\CommentTok{## 3  weights 0.23 0.17  0.12   0.34   0.15    0.19}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dflist}
\CommentTok{## $IndData}
\CommentTok{## # A tibble: 28 x 17}
\CommentTok{##    UnitName UnitCode ind.01 ind.02 ind.03 ind.04 ind.05 ind.06 ind.07 ind.08}
\CommentTok{##    <chr>    <chr>     <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>  <dbl>}
\CommentTok{##  1 Austria  AT         13.3   80.4   492.   14.9   68.8     34    3.7   87.6}
\CommentTok{##  2 Belgium  BE         15.1   71.8   503.    7     59.6     24    5.2   81.2}
\CommentTok{##  3 Bulgaria BG         12.3   78.1   440.    2.2   51.3     15   10.6   72  }
\CommentTok{##  4 Cyprus   CY         14     76     438.    6.9   16.7     23    3.6   73.4}
\CommentTok{##  5 Czech R~ CZ         13.5   87.6   491.    8.8   73.2     27    3.9   86.7}
\CommentTok{##  6 Germany  DE          9.7   80.2   508.    8.5   46.3     30    5.6   90.1}
\CommentTok{##  7 Denmark  DK          9.7   73     504.   27.7   40.6     39    3.8   83.9}
\CommentTok{##  8 Estonia  EE          8.6   83.3   524.   15.7   35.7     37    4.1   77.1}
\CommentTok{##  9 Greece   EL         11.8   70     458.    4     31.5     30    3.9   49.2}
\CommentTok{## 10 Spain    ES         14.9   57.4   491.    9.4   34.8     33   11.4   68  }
\CommentTok{## # ... with 18 more rows, and 7 more variables: ind.09 <dbl>, ind.10 <dbl>,}
\CommentTok{## #   ind.11 <dbl>, ind.12 <dbl>, ind.13 <dbl>, ind.14 <dbl>, ind.15 <dbl>}
\CommentTok{## }
\CommentTok{## $IndMeta}
\CommentTok{## # A tibble: 15 x 9}
\CommentTok{##    IndCode IndName         GPupper GPlower Direction IndWeight Agg1  Agg2  Agg3 }
\CommentTok{##    <chr>   <chr>             <dbl>   <dbl>     <dbl>     <dbl> <chr> <chr> <chr>}
\CommentTok{##  1 ind.01  Pre-primary pu~      NA      NA        -1      0.4  sp.01 p.01  Index}
\CommentTok{##  2 ind.02  Share of popul~      NA      NA         1      0.3  sp.01 p.01  Index}
\CommentTok{##  3 ind.03  Reading, maths~      NA      NA         1      0.3  sp.01 p.01  Index}
\CommentTok{##  4 ind.04  Recent training      NA      NA         1      0.3  sp.02 p.01  Index}
\CommentTok{##  5 ind.05  VET students         NA      NA         1      0.35 sp.02 p.01  Index}
\CommentTok{##  6 ind.06  High computer ~      NA      NA         1      0.35 sp.02 p.01  Index}
\CommentTok{##  7 ind.07  Early leavers ~      NA      NA        -1      0.7  sp.03 p.02  Index}
\CommentTok{##  8 ind.08  Recent graduat~      NA      NA         1      0.3  sp.03 p.02  Index}
\CommentTok{##  9 ind.09  Activity rate ~      NA      NA         1      0.5  sp.04 p.02  Index}
\CommentTok{## 10 ind.10  Activity rate ~      NA      NA         1      0.5  sp.04 p.02  Index}
\CommentTok{## 11 ind.11  Long-term unem~      NA      NA        -1      0.4  sp.05 p.03  Index}
\CommentTok{## 12 ind.12  Underemployed ~      NA      NA        -1      0.6  sp.05 p.03  Index}
\CommentTok{## 13 ind.13  Higher educati~      NA      NA        -1      0.4  sp.06 p.03  Index}
\CommentTok{## 14 ind.14  ISCED 5-8 prop~      NA      NA        -1      0.1  sp.06 p.03  Index}
\CommentTok{## 15 ind.15  Qualification ~      NA      NA        -1      0.5  sp.06 p.03  Index}
\CommentTok{## }
\CommentTok{## $AggMeta}
\CommentTok{## # A tibble: 10 x 4}
\CommentTok{##    AgLevel Code  Name                            Weight}
\CommentTok{##      <dbl> <chr> <chr>                            <dbl>}
\CommentTok{##  1       4 Index European Skills Index              1  }
\CommentTok{##  2       3 p.01  Skills Development                 0.3}
\CommentTok{##  3       3 p.02  Skills Activation                  0.3}
\CommentTok{##  4       3 p.03  Skills Matching                    0.4}
\CommentTok{##  5       2 sp.01 Compulsory education               0.5}
\CommentTok{##  6       2 sp.02 Training and tertiary education    0.5}
\CommentTok{##  7       2 sp.03 Transition to work                 0.5}
\CommentTok{##  8       2 sp.04 Activity rates                     0.5}
\CommentTok{##  9       2 sp.05 Unemployment                       0.4}
\CommentTok{## 10       2 sp.06 Skills mismatch                    0.6}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dflist <-}\StringTok{ }\KeywordTok{COINToolIn}\NormalTok{(fname, }\DataTypeTok{makecodes =} \OtherTok{TRUE}\NormalTok{)}
\CommentTok{## Imported 15 indicators and 28 units.}
\NormalTok{dflist}\OperatorTok{$}\NormalTok{IndMeta}\OperatorTok{$}\NormalTok{IndCode}
\CommentTok{##  [1] "Pre-Pupi"   "SharPopu"   "ReadMath"   "ReceTrai"   "Stud"      }
\CommentTok{##  [6] "HighComp"   "EarlLeav"   "ReceGrad"   "ActiRate"   "ActiRate_1"}
\CommentTok{## [11] "LongUnem"   "UndePart"   "HighEduc"   "Isce5-Pr"   "QualMism"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{datalist <-}\StringTok{ }\KeywordTok{getIn}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{)}
\NormalTok{datalist}\OperatorTok{$}\NormalTok{ind_data_only}
\CommentTok{## # A tibble: 51 x 49}
\CommentTok{##     Goods Services    FDI PRemit ForPort CostImpEx Tariff  TBTs TIRcon  RTAs}
\CommentTok{##     <dbl>    <dbl>  <dbl>  <dbl>   <dbl>     <dbl>  <dbl> <dbl>  <dbl> <dbl>}
\CommentTok{##  1 278.      108.   5      5.07    809.          0    1.6  1144      1    30}
\CommentTok{##  2 598.      216.   5.71  13.4    1574.          0    1.6  1348      1    30}
\CommentTok{##  3  42.8      13.0  1.35   1.04     15.5        52    1.6  1140      1    30}
\CommentTok{##  4  28.4      17.4  0.387  1.56     16.9         0    1.6  1179      1    30}
\CommentTok{##  5   8.77     15.2  1.23   0.477    40.8       100    1.6  1141      1    30}
\CommentTok{##  6 274.       43.5  3.88   4.69    108.          0    1.6  1456      1    30}
\CommentTok{##  7 147.      114.   9.1    2.19   1021.          0    1.6  1393      1    30}
\CommentTok{##  8  28.2      10.2  0.580  0.589    17.4         0    1.6  1153      1    30}
\CommentTok{##  9 102.       53.8  6.03   1.51    748.         70    1.6  1215      1    30}
\CommentTok{## 10 849.      471.  30.9   30.2    6745.          0    1.6  1385      1    30}
\CommentTok{## # ... with 41 more rows, and 39 more variables: Visa <dbl>, StMob <dbl>,}
\CommentTok{## #   Research <dbl>, Pat <dbl>, CultServ <dbl>, CultGood <dbl>, Tourist <dbl>,}
\CommentTok{## #   MigStock <dbl>, Lang <dbl>, LPI <dbl>, Flights <dbl>, Ship <dbl>,}
\CommentTok{## #   Bord <dbl>, Elec <dbl>, Gas <dbl>, ConSpeed <dbl>, Cov4G <dbl>, Embs <dbl>,}
\CommentTok{## #   IGOs <dbl>, UNVote <dbl>, Renew <dbl>, PrimEner <dbl>, CO2 <dbl>,}
\CommentTok{## #   MatCon <dbl>, Forest <dbl>, Poverty <dbl>, Palma <dbl>, TertGrad <dbl>,}
\CommentTok{## #   FreePress <dbl>, TolMin <dbl>, NGOs <dbl>, CPI <dbl>, FemLab <dbl>,}
\CommentTok{## #   WomParl <dbl>, PubDebt <dbl>, PrivDebt <dbl>, GDPGrow <dbl>, RDExp <dbl>,}
\CommentTok{## #   NEET <dbl>}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Get raw data set}
\NormalTok{datalist <-}\StringTok{ }\KeywordTok{getIn}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{icodes =} \KeywordTok{c}\NormalTok{(}\StringTok{"Flights"}\NormalTok{, }\StringTok{"LPI"}\NormalTok{))}
\NormalTok{datalist}\OperatorTok{$}\NormalTok{ind_data_only}
\CommentTok{## # A tibble: 51 x 2}
\CommentTok{##    Flights   LPI}
\CommentTok{##      <dbl> <dbl>}
\CommentTok{##  1   29.0   4.10}
\CommentTok{##  2   31.9   4.11}
\CommentTok{##  3    9.24  2.81}
\CommentTok{##  4    9.25  3.16}
\CommentTok{##  5    8.75  3.00}
\CommentTok{##  6   15.3   3.67}
\CommentTok{##  7   32.8   3.82}
\CommentTok{##  8    3.13  3.36}
\CommentTok{##  9   18.9   3.92}
\CommentTok{## 10   97.6   3.90}
\CommentTok{## # ... with 41 more rows}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Get raw data set}
\NormalTok{datalist <-}\StringTok{ }\KeywordTok{getIn}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Raw"}\NormalTok{, }\DataTypeTok{icodes =} \StringTok{"Political"}\NormalTok{, }\DataTypeTok{aglev =} \DecValTok{1}\NormalTok{)}
\NormalTok{datalist}\OperatorTok{$}\NormalTok{ind_data_only}
\CommentTok{## # A tibble: 51 x 3}
\CommentTok{##     Embs  IGOs UNVote}
\CommentTok{##    <dbl> <dbl>  <dbl>}
\CommentTok{##  1    88   227   42.6}
\CommentTok{##  2    84   248   43.0}
\CommentTok{##  3    67   209   43.0}
\CommentTok{##  4    62   197   42.7}
\CommentTok{##  5    43   172   42.3}
\CommentTok{##  6    84   201   42.2}
\CommentTok{##  7    77   259   42.8}
\CommentTok{##  8    46   194   42.9}
\CommentTok{##  9    74   269   42.7}
\CommentTok{## 10   100   329   40.4}
\CommentTok{## # ... with 41 more rows}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Get raw data set}
\NormalTok{datalist <-}\StringTok{ }\KeywordTok{getIn}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Aggregated"}\NormalTok{, }\DataTypeTok{icodes =} \StringTok{"Conn"}\NormalTok{, }\DataTypeTok{aglev =} \DecValTok{1}\NormalTok{)}
\NormalTok{datalist}\OperatorTok{$}\NormalTok{ind_data_only}
\CommentTok{## # A tibble: 51 x 30}
\CommentTok{##    Goods Services   FDI PRemit ForPort CostImpEx Tariff  TBTs TIRcon  RTAs  Visa}
\CommentTok{##    <dbl>    <dbl> <dbl>  <dbl>   <dbl>     <dbl>  <dbl> <dbl>  <dbl> <dbl> <dbl>}
\CommentTok{##  1  40.7     33.0  6.24  16.8    34.2      100     79.2  34.8    100  64.4  86.8}
\CommentTok{##  2  80.1     58.7  5.79  40.9    55.7      100     79.2  23.2    100  64.4  86.8}
\CommentTok{##  3  47.1     28.4 15.8   26.9     4.82      91.3   79.2  35.0    100  64.4  85.7}
\CommentTok{##  4  29.7     41.6  2.26  43.9     5.45     100     79.2  32.8    100  64.4  84.6}
\CommentTok{##  5  21.6    100   43.1   33.6    33.6       83.2   79.2  35.0    100  64.4  85.7}
\CommentTok{##  6  88.9     25.5 11.6   33.9     9.12     100     79.2  17.0    100  64.4  85.7}
\CommentTok{##  7  24.4     46.0 19.0    7.73   55.1      100     79.2  20.6    100  64.4  87.9}
\CommentTok{##  8  75.4     55.4 15.4   35.8    12.3      100     79.2  34.3    100  64.4  85.7}
\CommentTok{##  9  20.8     25.9 15.7    6.50   51.9       88.2   79.2  30.7    100  64.4  87.9}
\CommentTok{## 10  15.1     21.1  6.04  15.7    45.3      100     79.2  21.0    100  64.4  87.9}
\CommentTok{## # ... with 41 more rows, and 19 more variables: StMob <dbl>, Research <dbl>,}
\CommentTok{## #   Pat <dbl>, CultServ <dbl>, CultGood <dbl>, Tourist <dbl>, MigStock <dbl>,}
\CommentTok{## #   Lang <dbl>, LPI <dbl>, Flights <dbl>, Ship <dbl>, Bord <dbl>, Elec <dbl>,}
\CommentTok{## #   Gas <dbl>, ConSpeed <dbl>, Cov4G <dbl>, Embs <dbl>, IGOs <dbl>,}
\CommentTok{## #   UNVote <dbl>}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Get raw data set}
\NormalTok{datalist <-}\StringTok{ }\KeywordTok{getIn}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Aggregated"}\NormalTok{, }\DataTypeTok{icodes =} \StringTok{"Conn"}\NormalTok{, }\DataTypeTok{aglev =} \DecValTok{2}\NormalTok{)}
\NormalTok{datalist}\OperatorTok{$}\NormalTok{ind_data_only}
\CommentTok{## # A tibble: 51 x 5}
\CommentTok{##    ConEcFin Instit   P2P Physical Political}
\CommentTok{##       <dbl>  <dbl> <dbl>    <dbl>     <dbl>}
\CommentTok{##  1     26.2   77.5  54.1     41.1      78.2}
\CommentTok{##  2     48.2   75.6  43.3     72.0      80.8}
\CommentTok{##  3     24.6   75.9  27.1     28.4      67.5}
\CommentTok{##  4     24.6   76.8  39.1     47.6      62.6}
\CommentTok{##  5     46.4   74.6  59.8     29.5      48.7}
\CommentTok{##  6     33.8   74.4  39.6     41.5      71.0}
\CommentTok{##  7     30.4   75.4  51.0     50.5      78.1}
\CommentTok{##  8     38.9   77.3  53.5     42.5      55.4}
\CommentTok{##  9     24.1   75.1  39.1     44.5      77.9}
\CommentTok{## 10     20.6   75.4  28.4     42.4      87.6}
\CommentTok{## # ... with 41 more rows}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# Get raw data set}
\NormalTok{datalist <-}\StringTok{ }\KeywordTok{getIn}\NormalTok{(ASEM, }\DataTypeTok{dset =} \StringTok{"Aggregated"}\NormalTok{, }\DataTypeTok{icodes =} \StringTok{"Conn"}\NormalTok{)}
\NormalTok{datalist}\OperatorTok{$}\NormalTok{ind_data_only}
\CommentTok{## # A tibble: 51 x 1}
\CommentTok{##     Conn}
\CommentTok{##    <dbl>}
\CommentTok{##  1  55.4}
\CommentTok{##  2  64.0}
...
\NormalTok{datalist <-}\StringTok{ }\KeywordTok{getIn}\NormalTok{(ASEMIndData, }\DataTypeTok{icodes =} \KeywordTok{c}\NormalTok{(}\StringTok{"LPI"}\NormalTok{, }\StringTok{"Goods"}\NormalTok{))}
\NormalTok{datalist}\OperatorTok{$}\NormalTok{ind_data_only}
\CommentTok{## # A tibble: 51 x 2}
\CommentTok{##      LPI  Goods}
\CommentTok{##    <dbl>  <dbl>}
\CommentTok{##  1  4.10 278.  }
\CommentTok{##  2  4.11 598.  }
\CommentTok{##  3  2.81  42.8 }
\CommentTok{##  4  3.16  28.4 }
\CommentTok{##  5  3.00   8.77}
\CommentTok{##  6  3.67 274.  }
\CommentTok{##  7  3.82 147.  }
\CommentTok{##  8  3.36  28.2 }
\CommentTok{##  9  3.92 102.  }
\CommentTok{## 10  3.90 849.  }
\CommentTok{## # ... with 41 more rows}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# use the ASEM indicator data frame directly}
\KeywordTok{library}\NormalTok{(magrittr)}
\NormalTok{ASEMIndData }\OperatorTok{%>%}\StringTok{ }\KeywordTok{roundDF}\NormalTok{(}\DataTypeTok{decimals =} \DecValTok{3}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{reactable}\OperatorTok{::}\KeywordTok{reactable}\NormalTok{(}\DataTypeTok{defaultPageSize =} \DecValTok{5}\NormalTok{, }\DataTypeTok{highlight =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{wrap =}\NormalTok{ F)}
\end{Highlighting}
\end{Shaded}
